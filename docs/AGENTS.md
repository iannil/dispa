...
- docs/: user/dev manuals (docs/DEVELOPMENT.md, docs/PLUGINS.md); LLM helpers in docs/internal/llm-friendly/.
...
- Keep changes minimal and verifiable; run `make quick` often and `make qa` before committing; see `docs/internal/llm-friendly/LLM_PLAN.md`.
